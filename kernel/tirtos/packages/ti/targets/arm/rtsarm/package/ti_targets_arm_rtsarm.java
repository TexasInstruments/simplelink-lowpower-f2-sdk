...
public class ti_targets_arm_rtsarm
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/ti.targets.arm.rtsarm.aer5ft',\n");
            sb.append("'lib/boot.aer5ft',\n");
            sb.append("'lib/auto_init.aer5ft',\n");
            sb.append("'lib/ti.targets.arm.rtsarm.am33',\n");
            sb.append("'lib/startup.am33',\n");
            ...
            sb.append("'lib/startup.am3',\n");
            sb.append("'lib/ti.targets.arm.rtsarm.am0',\n");
            sb.append("'lib/startup.am0',\n");
            sb.append("'lib/ti.targets.arm.rtsarm.ar5f',\n");
            sb.append("'lib/startup.ar5f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/ti.targets.arm.rtsarm.aer5ft', {target: 'ti.targets.arm.elf.R5Ft', suffix: 'er5ft'}],\n");
            sb.append("['lib/boot.aer5ft', {target: 'ti.targets.arm.elf.R5Ft', suffix: 'er5ft'}],\n");
            sb.append("['lib/auto_init.aer5ft', {target: 'ti.targets.arm.elf.R5Ft', suffix: 'er5ft'}],\n");
            sb.append("['lib/ti.targets.arm.rtsarm.am33', {target: 'ti.targets.arm.clang.M33', suffix: 'm33'}],\n");
            sb.append("['lib/startup.am33', {target: 'ti.targets.arm.clang.M33', suffix: 'm33'}],\n");
            ...
            sb.append("['lib/ti.targets.arm.rtsarm.am3', {target: 'ti.targets.arm.clang.M3', suffix: 'm3'}],\n");
            sb.append("['lib/startup.am3', {target: 'ti.targets.arm.clang.M3', suffix: 'm3'}],\n");
            sb.append("['lib/ti.targets.arm.rtsarm.am0', {target: 'ti.targets.arm.clang.M0', suffix: 'm0'}],\n");
            sb.append("['lib/startup.am0', {target: 'ti.targets.arm.clang.M0', suffix: 'm0'}],\n");
            sb.append("['lib/ti.targets.arm.rtsarm.ar5f', {target: 'ti.targets.arm.clang.R5F', suffix: 'r5f'}],\n");
            sb.append("['lib/startup.ar5f', {target: 'ti.targets.arm.clang.R5F', suffix: 'r5f'}],\n");
        sb.append("];\n");
