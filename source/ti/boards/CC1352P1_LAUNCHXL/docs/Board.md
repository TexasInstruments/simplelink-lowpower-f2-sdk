...
The [__SimpleLink&trade; CC1352P1 LaunchPad&trade;__][board] contains a
...
On the CC1352P1_LAUNCHXL board, bend down the following BoosterPack header pins:
...
Attach the CC3200 Audio BoosterPack to the CC1352P1_LAUNCHXL and run jumper wires
