			   ...
			   struct net_buf_simple *buf)
{
	...
	(void)bt_mesh_gatt_proxy_set((enum bt_mesh_feat_state) buf->data[0]);
		      ...
		      struct net_buf_simple *buf)
{
	...
	(void)bt_mesh_relay_set((enum bt_mesh_feat_state) buf->data[0], buf->data[1]);
			      ...
			      struct net_buf_simple *buf)
{
	...
	status = bt_mesh_subnet_node_id_set(idx, (enum bt_mesh_feat_state) node_id);
		       ...
		       struct net_buf_simple *buf)
{
	...
	(void)bt_mesh_friend_set((enum bt_mesh_feat_state) buf->data[0]);
