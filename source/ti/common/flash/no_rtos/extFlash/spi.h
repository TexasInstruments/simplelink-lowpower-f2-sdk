...
#define SPI_FRF_MOTO_MODE_0     ( SPI_CTL0_FRF_MOTOROLA_3WIRE | SPI_CTL0_SPO_LOW | SPI_CTL0_SPH_FIRST )
//! Motorola format 3-wire, polarity 0, phase 1
#define SPI_FRF_MOTO_MODE_1     ( SPI_CTL0_FRF_MOTOROLA_3WIRE | SPI_CTL0_SPO_LOW | SPI_CTL0_SPH_SECOND )
//! Motorola format 3-wire, polarity 1, phase 0
#define SPI_FRF_MOTO_MODE_2     ( SPI_CTL0_FRF_MOTOROLA_3WIRE | SPI_CTL0_SPO_HIGH | SPI_CTL0_SPH_FIRST )
//! Motorola format 3-wire, polarity 1, phase 1
#define SPI_FRF_MOTO_MODE_3     ( SPI_CTL0_FRF_MOTOROLA_3WIRE | SPI_CTL0_SPO_HIGH | SPI_CTL0_SPH_SECOND )
//! Motorola format 4-wire, polarity 0, phase 0
#define SPI_FRF_MOTO_MODE_4     ( SPI_CTL0_FRF_MOTOROLA_4WIRE | SPI_CTL0_SPO_LOW | SPI_CTL0_SPH_FIRST )
//! Motorola format 4-wire, polarity 0, phase 1
#define SPI_FRF_MOTO_MODE_5     ( SPI_CTL0_FRF_MOTOROLA_4WIRE | SPI_CTL0_SPO_LOW | SPI_CTL0_SPH_SECOND )
//! Motorola format 4-wire, polarity 1, phase 0
#define SPI_FRF_MOTO_MODE_6     ( SPI_CTL0_FRF_MOTOROLA_4WIRE | SPI_CTL0_SPO_HIGH | SPI_CTL0_SPH_FIRST )
//! Motorola format 4-wire, polarity 1, phase 1
#define SPI_FRF_MOTO_MODE_7     ( SPI_CTL0_FRF_MOTOROLA_4WIRE | SPI_CTL0_SPO_HIGH | SPI_CTL0_SPH_SECOND )
...
#define SPI_MODE_CONTROLLER     SPI_CTL1_MS_MASTER  //!< SPI controller
#define SPI_MODE_PERIPHERAL     SPI_CTL1_MS_SLAVE   //!< SPI peripheral
...
SPIEnable(uint32_t ui32Base)
{
    ...
    HWREG(ui32Base + SPI_O_CTL1) |= SPI_CTL1_EN_ENABLE;
}
