...
shapeBase17_t shapeGfskBT1Base = {
...
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t RF_cmdPropRadioDivSetup =
{
    ...
    .rxBw = 0x53, // 0x52 - 98kHz; 0x53 - 117.7kHz
    .preamConf.nPreamBytes = 0x1, // 0x7 - preamble 7B; 0x2 - preamble 2B
    ...
    .txPower = 0xFFFF,
    .pRegOverride = pOverrides_BT05,
    .centerFreq = 0x0398, // 0x0393 - 915MHz; 0x0398 - 920MHz
    .intFreq = 0x8000,
    .loDivider = 0x05,
...
rfc_CMD_FS_t RF_cmdFs =
{
    ...
    .condition.rule = 0x1,
    .condition.nSkip = 0x0,
    .frequency = 0x0398, // 0x0393 - 915MHz; 0x0398 - 920MHz
    .fractFreq = 0x0000,
