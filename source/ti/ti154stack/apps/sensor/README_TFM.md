...
This sensor example leverages Trusted Firmware-M (TFM) to provide increased security for applications based on the CC13x4 and CC26x4 family of devices. This partitions memory into distinct memory regions, both secure and non-secure. More information about TFM and TI's implementation can be found under the security section of the ble5stack user guide. 
