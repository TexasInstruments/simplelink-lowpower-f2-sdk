...
void protocol_6lowpan_stack(buffer_t *b)
{
    ...
    while (b) {
        ...
        if ((b->info & B_DIR_MASK) == B_DIR_DOWN) {
            /* Direction DOWN */
            tr_extra_debug("protocol_6lowpan_stack:B_DIR_DOWN");
            switch (b->info & B_TO_MASK) {
                case B_TO_ICMP:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_ICMP");
                    /* Build ICMP Header */
                    b = icmpv6_down(b);
                    break;
                case B_TO_UDP:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_UDP");
                    /* Build UDP Header */
                    b = udp_down(b);
                    break;

                case B_TO_IPV6:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_IPV6");
                    /* Build IP header */
                    b = ipv6_down(b);
                    break;

                case B_TO_IPV6_FWD:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_IPV6_FWD");
                    /* IPv6 forwarding */
                    b = ipv6_forwarding_down(b);
                    break;

                case B_TO_IPV6_TXRX:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_IPV6_TXRX");
                ...
                case B_TO_MAC:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_MAC");
                /* no break */
                case B_TO_PHY:
            ...
            /* Direction UP */
            tr_extra_debug("protocol_6lowpan_stack:B_DIR_UP");
            switch (b->info & B_TO_MASK) {
                case B_TO_APP:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_APP");
                ...
                case B_TO_FRAGMENTATION:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_FRAG");
                    /* Packet Reasemley */
                ...
                case B_TO_UDP:
                    ...
                    break;
                case B_TO_IPV6_FWD:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_IPv6 FWD");
                    /* Handle IP Payload */
...
#endif
                case B_TO_TCP:
                    tr_extra_debug("protocol_6lowpan_stack:B_TO_TCP");
                    b = tcp_up(b);
                    break;
                default:
                    tr_debug("LLL\n");
        ...
        if (b) {
            ...
            if (b->interface != cur) {
                tr_extra_debug("protocol_6lowpan_stack:protocol_push to next layer");
                protocol_push(b);
                b = 0;
            }
        }
