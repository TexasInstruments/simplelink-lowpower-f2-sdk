...
#ifdef NV_RESTORE
#define KEY_STORAGE_INDEX_FILE                        "key_strge_index" //purposefully ensuring sub string of this does not match with below one
#else
...
#ifdef NV_RESTORE
#define DEFAULT_NUMBER_OF_ENTRIES_IN_ONE_STORAGE   1
#else
...
#define DEFAULT_STORING_INTERVAL                   60//3600
