...
void ws_pae_timers_settings_init(sec_timer_cfg_t *timer_settings, ws_sec_timer_cfg_t *new_timer_settings)
{
...
#ifdef GTK_CERT_TEST
    timer_settings->gtk_expire_offset = 20 * SECONDS_IN_MINUTE;
    timer_settings->pmk_lifetime = 80 * SECONDS_IN_MINUTE;
    timer_settings->ptk_lifetime = 40 * SECONDS_IN_MINUTE;
    timer_settings->gtk_new_act_time = 10; //new_timer_settings->gtk_new_act_time;
    timer_settings->revocat_lifetime_reduct = 3;
    timer_settings->gtk_request_imin = 1; //new_timer_settings->gtk_request_imin * SECONDS_IN_MINUTE;
    timer_settings->gtk_request_imax = 1;// new_timer_settings->gtk_request_imax * SECONDS_IN_MINUTE;
    timer_settings->gtk_max_mismatch = 1 * SECONDS_IN_MINUTE;
    timer_settings->gtk_new_install_req = 20; //new_timer_settings->gtk_new_install_req;
#elif defined(GTK_CERT_TEST_FULL_CYCLE)
    timer_settings->gtk_expire_offset = 15 * SECONDS_IN_MINUTE;
    timer_settings->pmk_lifetime = 60 * SECONDS_IN_MINUTE;
    timer_settings->ptk_lifetime = 30 * SECONDS_IN_MINUTE;
    timer_settings->gtk_new_act_time = 5; //new_timer_settings->gtk_new_act_time;
    timer_settings->revocat_lifetime_reduct = 30;
    timer_settings->gtk_request_imin = 1; //new_timer_settings->gtk_request_imin * SECONDS_IN_MINUTE;
    timer_settings->gtk_request_imax = 1;// new_timer_settings->gtk_request_imax * SECONDS_IN_MINUTE;
    timer_settings->gtk_max_mismatch = 1 * SECONDS_IN_MINUTE;
    timer_settings->gtk_new_install_req = 20; //new_timer_settings->gtk_new_install_req;
    ...
    timer_settings->gtk_new_act_time = 10;
    timer_settings->revocat_lifetime_reduct = 3;
    timer_settings->gtk_request_imin = 1; //new_timer_settings->gtk_request_imin * SECONDS_IN_MINUTE;
    timer_settings->gtk_request_imax = 1;// new_timer_settings->gtk_request_imax * SECONDS_IN_MINUTE;
    timer_settings->gtk_max_mismatch = 1 * SECONDS_IN_MINUTE;
    timer_settings->gtk_new_install_req = 20;
#else
