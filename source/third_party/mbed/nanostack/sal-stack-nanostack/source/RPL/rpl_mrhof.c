...
static void rpl_mrhof_parent_selection(rpl_instance_t *instance)
{
    ...
    rpl_dodag_t *dodag;
    tr_extra_debug("\n Calling rpl_mrhof_parent_selection ");
    ...
    tr_extra_debug("\n set pref_parent = true for %s", trace_ipv6(pref_parent->ll_address));
    ...
    while (more_successors--) {
        ...
        tr_extra_debug("\n set backup pref_parent = true for %s", trace_ipv6(backup->ll_address));
