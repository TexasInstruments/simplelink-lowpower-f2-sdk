    ...
    size_t *signature_length )
{
    ...
    /* TI-MBEDTLS: The following return statement is unreachable */
    // return status;
}
...
psa_status_t psa_driver_wrapper_sign_hash_get_num_ops(
...
psa_status_t psa_driver_wrapper_verify_hash_get_num_ops(
