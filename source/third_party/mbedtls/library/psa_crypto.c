                                   ...
                                   size_t *data_length)
{
    ...
    psa_status_t unlock_status = PSA_ERROR_CORRUPTION_DETECTED;
    psa_key_slot_t *slot;
    /* TI-MBEDTLS: Declare variables at the beginning of function to avoid 
     * compiler warning on transfer of control before initialization of variables */
     psa_key_attributes_t attributes;
    ...
    *data_length = 0;
    ...
    /* TI-MBEDTLS: attributes declaration moved up to avoid compiler warning */
    attributes.core = slot->attr;
    ...
    psa_se_drv_table_entry_t **p_drv)
{
    ...
    *p_drv = NULL;
    ...
    if (PSA_KEY_LIFETIME_IS_VOLATILE(slot->attr.lifetime)) {
        ...
        /* TI-MBEDTLS: Initialize the default owner with default 
         * non-secure owner from TF-M */
        slot->attr.id.owner = MBEDTLS_PSA_CRYPTO_KEY_ID_DEFAULT_OWNER;
#endif
    }
                                ...
                                size_t *output_length)
{
    ...
    /* TI-MBEDTLS: p and c declaration moved up to avoid compiler warning */
    attributes.core = slot->attr;
                                                ...
                                                size_t nonce_length)
{
    ...
    /* TI-MBEDTLS: Avoid compiler warning about no return in a non-void functions */
    return PSA_ERROR_NOT_SUPPORTED;
}
    ...
    )
{
    ...
    /* TI-MBEDTLS: m and m_bytes declaration moved up to avoid compiler warning */
                                   ...
                                   size_t *output_length)
{
    ...
    /* TI-MBEDTLS: expected_length declaration moved up to avoid compiler warning */
...
/*
 * TI-MBEDTLS: mbedcrypto drbg is not used for RNG by TI drivers
 * Function definition commented to prevent unused compiler warning
 */
...
/* TI-MBEDTLS: The following statements are unreachable for KeyStore builds */
#if !defined(MBEDTLS_TI_KEYSTORE_BUILD)
    operation->stage = PSA_PAKE_OPERATION_STAGE_COLLECT_INPUTS;
    return PSA_SUCCESS;
#endif /* MBEDTLS_TI_KEYSTORE_BUILD */
    ...
    mbedtls_svc_key_id_t password)
{
    ...
    /* TI-MBEDTLS: attribute and type variable declaration moved up to avoid compiler warning */
    attributes.core = slot->attr;
