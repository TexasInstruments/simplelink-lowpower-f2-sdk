/**
 * \file config-tidrivers.h
 *
 * \brief Configuration options (set of defines) for KeyStore
 *        support with TI SL drivers.
 *
...
/**
 * This is custom define for TI that disables certain features
