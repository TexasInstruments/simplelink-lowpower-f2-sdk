...
static psa_storage_uid_t psa_its_identifier_of_slot( psa_key_file_id_t file_id )
{
    ...
    /* TI-MBEDCRYPTO: Removed PSA_CRYPTO_SECURE to use with both S-only
     * and S/NS design
     */
    /*
     * && \
...
/* TI-MBEDCRYPTO: Moved persistent_key_storage_format to header file to 
 * use it with pre-provisioned keys TI KeyStore driver
 */
/**
