...
#define RNET_MAX_FSK_APP_PLD_SIZE 202  // 200B max FSK APP PAYLOAD + 1B expl_data_len + 1B status code
// Max application payload size in FSK (Non-UASL)
#define RNET_MAX_PAYLOAD_SZ_UASL_NO_SUPPORT 94
#define RNET_MAX_PAYLOAD_SZ_SDB RNET_MAX_PAYLOAD_SZ_UASL_NO_SUPPORT
