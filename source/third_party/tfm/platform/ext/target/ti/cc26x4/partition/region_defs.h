...
#else
#define NS_IMAGE_PRIMARY_PARTITION_OFFSET (FLASH_AREA_1_OFFSET + FLASH_S_PARTITION_SIZE)
#endif /* !LINK_TO_SECONDARY_PARTITION */
#else
...
#else
/* TI's secondary bootloader has a header size of 256-bytes and trailer of 4KB. */
