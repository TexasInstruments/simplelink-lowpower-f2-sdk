                               ...
                               uint32_t lr)
{
    ...
    case TFM_SVC_PSA_EOI:
        tfm_spm_psa_eoi(ctx);
        break;
    /* [TI-TFM] Handle EOI without enabling IRQ */
    case TFM_SVC_PSA_EOI_NO_IRQ_EN:
        tfm_spm_psa_eoi_no_irq_en(ctx);
        break;
...
/* [TI-TFM] Updated function for TF-M Security Advisory fix for TFMV-1 */
