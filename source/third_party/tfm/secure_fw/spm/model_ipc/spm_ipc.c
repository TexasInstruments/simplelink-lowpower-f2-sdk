...
/* [TI-TFM] Changed next two include statements to use angle brackets to support out of build process */
...
/* [TI-TFM] Changed next include statement to use angle brackets to support out of build process */
...
/* [TI-TFM] Added tfm_spm_psa_eoi_no_irq_en to support level-triggered interrupt */
void tfm_spm_psa_eoi_no_irq_en(uint32_t *args)
{
