...
/* [TI-SPE] Changed next two include statements to use angle brackets to support out of build process */
...
/* [TI-SPE] Changed next include statement to use angle brackets to support out of build process */
