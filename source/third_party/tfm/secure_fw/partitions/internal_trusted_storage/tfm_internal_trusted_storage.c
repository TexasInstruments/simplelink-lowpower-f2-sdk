...
{
    /* [TI-SPE] Reversed conditional to check for TFM_SP_ITS instead of TFM_SP_PS */
    return (client_id == TFM_SP_ITS) ? &fs_ctx_its : &fs_ctx_ps;
}
...
/* [TI-SPE] Added #ifdef TFM_PARTITION_PROTECTED_STORAGE to fix failure when PS is disabled */
