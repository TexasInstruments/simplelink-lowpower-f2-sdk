...
if (_CXX_COMPILER_NAME MATCHES "^tiarmclang(\\.exe)?$")
	set(CMAKE_CXX_COMPILER_ID "TICLANGARM" CACHE INTERNAL "C++ compiler ID" FORCE)
	set(ARM_TOOLCHAIN_FILE "Compiler/TIClangArm-CXX")
elseif (_CXX_COMPILER_NAME MATCHES "^.*armclang(\\.exe)?$")
