...
# Create imported target Drivers::drivers_cc13x2
add_library(Drivers::drivers_cc13x2 STATIC IMPORTED)

set_target_properties(Drivers::drivers_cc13x2 PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/source"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Tirtos7Generic::tirtos7>;Driverlib::cc13x2;TOOLCHAIN_gcc_m4f;TiUtils::json_m4f"
)
...
add_library(Drivers::drivers_cc26x2 STATIC IMPORTED)

set_target_properties(Drivers::drivers_cc26x2 PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/source"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Tirtos7Generic::tirtos7>;Driverlib::cc26x2;TOOLCHAIN_gcc_m4f;TiUtils::json_m4f"
)
...
add_library(Drivers::drivers_cc13x2x7 STATIC IMPORTED)

set_target_properties(Drivers::drivers_cc13x2x7 PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/source"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Tirtos7Generic::tirtos7>;Driverlib::cc13x2x7;TOOLCHAIN_gcc_m4f;TiUtils::json_m4f"
)
...
add_library(Drivers::drivers_cc26x2x7 STATIC IMPORTED)

set_target_properties(Drivers::drivers_cc26x2x7 PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/source"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Tirtos7Generic::tirtos7>;Driverlib::cc26x2x7;TOOLCHAIN_gcc_m4f;TiUtils::json_m4f"
)
...
file(GLOB CONFIG_FILES "${_DIR}/DriversM4FTargets-*.cmake")
